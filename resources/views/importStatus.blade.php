<x-layout>
    ...
    @foreach ($imports as $import)
        <dl class="import-meta import-meta-{{ $import->status }}">
            <dt><a class="button primary neutral" href="{{ route('store.imports-overview', [ $import->id ]) }}"><img src="{{ asset('/images/download-stats-black.svg') }}" class="button-icon button-white-fill" />{{__('store-layout.button:download-import-csv') }}</a></dt>
